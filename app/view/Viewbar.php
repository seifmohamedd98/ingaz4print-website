...
/*if (version_compare(phpversion(), '5.4.0', '<')) {
 ...
 require_once(__ROOT__ . "controller\MessagesController.php");
	...
	$model2=new Message();
	$controller2=new MessageController($model2);
...
class Bar extends View1
{
	...
	{
		$str="";	
		$str.='<li><a href="ClientOrders.php"><span class="glyphicon glyphicon-shopping-cart"></span> Client Orders</a></li>';
	...
	{
		$str="";	
        $str.='<li><a href="orderhistory.php"><span class="glyphicon glyphicon-calendar"></span> Order History</a></li>';
